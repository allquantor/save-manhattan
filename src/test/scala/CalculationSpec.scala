...
class CalculationSpec extends FlatSpec with Matchers {
  ...
  "Space laser area calculator" should
    ...
    SpaceLaserAreaCalculator.calculate(combined) should be(combinedAreaResult)
    ...
    SpaceLaserAreaCalculator.calculate(q) should be(qres)
    ...
    SpaceLaserAreaCalculator.calculate(qw) should be(qwres)
